 ...
 * @author villadora
 */
public class AlibabaVLayoutActivity extends Activity {
...
//    private static final boolean BANNER_LAYOUT = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alibaba_vlayout_main_activity);
...
//        }
    ...
    static class SubAdapter extends DelegateAdapter.Adapter<MainViewHolder> {
        ...
        @Override
        public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MainViewHolder(LayoutInflater.from(mContext).inflate(R.layout.alibaba_vlayout_item, parent, false));
        }
